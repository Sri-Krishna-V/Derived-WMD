  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-[10px] text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        purple: "bg-purple-500 text-white hover:bg-purple-600 [box-shadow:inset_0px_-2px_0px_0px_#5b21b6,_0px_1px_6px_0px_rgba(139,_92,_246,_58%)] hover:translate-y-[1px] hover:scale-[0.98] hover:[box-shadow:inset_0px_-1px_0px_0px_#5b21b6,_0px_1px_3px_0px_rgba(139,_92,_246,_40%)] active:translate-y-[2px] active:scale-[0.97] active:[box-shadow:inset_0px_1px_1px_0px_#5b21b6,_0px_1px_2px_0px_rgba(139,_92,_246,_30%)] disabled:shadow-none disabled:hover:translate-y-0 disabled:hover:scale-100",
